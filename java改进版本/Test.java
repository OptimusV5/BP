...
//         System.out.print(i+" ");
        ...
        try {
            ...
            FileReader file = new FileReader("E://digitstra.txt");
            ...
            while (line != null) {
                ...
                while (con < 64) {
                    ...
                    if (tmp != ',') {
                        ...
                        // }
                        // else if(line.charAt(line.length()-1) == '2'){
                        // 	output[0] = 0; output[1] = 0; output[2] = 1; output[3] = 0;
                        // }
                        // else if(line.charAt(line.length()-1) == '3'){
                        // 	output[0] = 0; output[1] = 0; output[2] = 1; output[3] = 1;
                        // }
                        // else if(line.charAt(line.length()-1) == '4'){
                        // 	output[0] = 0; output[1] = 1; output[2] = 0; output[3] = 0;
                        // }
                        // else if(line.charAt(line.length()-1) == '5'){
                        // 	output[0] = 0; output[1] = 1; output[2] = 0; output[3] = 1;
                        // }
                        // else if(line.charAt(line.length()-1) == '6'){
                        // 	output[0] = 0; output[1] = 1; output[2] = 1; output[3] = 0;
                        // }
                        // else if(line.charAt(line.length()-1) == '7'){
                        // 	output[0] = 0; output[1] = 1; output[2] = 1; output[3] = 1;
                        // }
                        // else if(line.charAt(line.length()-1) == '8'){
                        // 	output[0] = 1; output[1] = 0; output[2] = 0; output[3] = 0;
                        // }
                        // else if(line.charAt(line.length()-1) == '9'){
        ...
        try {
            ...
            FileReader ff = new FileReader("E://digitstest.txt");
